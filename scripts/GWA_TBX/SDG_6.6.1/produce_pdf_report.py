...
##SDG 6.6.1 - produce report for a given period=name
##ParameterFile|json_file|JSON file with the statistics|False|False|json
##ParameterRaster|raster|Classification map for the period to report on|False
##ParameterVector|vector|Regional polygons|2|False
##ParameterString|period|Period to report on|2018
...
@alg(
    name="sdg661producereportforagivenperiod",
    label=alg.tr("SDG 6.6.1 - produce report for a given period"),
    group="notupdated",
...
def sdg661producereportforagivenperiod(instance, parameters, context, feedback, inputs):
    ...
    composition = QgsPrintLayout(map_settings)
