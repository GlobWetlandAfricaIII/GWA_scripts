...
@alg.input(
    type=alg.BOOL, name="CloudBuffer", label="Process cloud buffer", default=True
)
@alg.input(
    type=alg.NUMBER,
...
def pg04waterqualityparameter01olciidepix(
    ...
    OutputCloudProbabilityFeatureValue = instance.parameterAsBool(
    ...
    def create_parameterfile(
        tempdir, CloudBuffer, CloudBufferWidth, OutputCloudProbabilityFeatureValue
    ):
