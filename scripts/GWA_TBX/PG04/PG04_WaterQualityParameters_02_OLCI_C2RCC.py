...
@alg.input(type=alg.NUMBER, name="AverageSalinity",
           label="Average Salinity", default=1, minValue=0)
@alg.input(type=alg.NUMBER, name="AverageTemperature",
           label="Average Temperature", default=15, minValue=0)
@alg.input(type=alg.STRING, name="validExpression",
           label="Valid pixel expression", default="not quality_flags.invalid and (not pixel_classif_flags.IDEPIX_LAND or quality_flags.fresh_inland_water) and not (pixel_classif_flags.IDEPIX_CLOUD or pixel_classif_flags.IDEPIX_CLOUD_BUFFER)")
@alg.input(type=alg.NUMBER, name="Vic01", advanced=True,
           label="Vicarious gains for Oa01", default=1.0206, minValue=0)
@alg.input(type=alg.NUMBER, name="Vic02", advanced=True,
           label="Vicarious gains for Oa02", default=1.0290, minValue=0)
@alg.input(type=alg.NUMBER, name="Vic03", advanced=True,
           label="Vicarious gains for Oa03", default=1.0260, minValue=0)
@alg.input(type=alg.NUMBER, name="Vic04", advanced=True,
           label="Vicarious gains for Oa04", default=1.0224, minValue=0)
@alg.input(type=alg.NUMBER, name="Vic05", advanced=True,
           label="Vicarious gains for Oa05", default=1.0176, minValue=0)
@alg.input(type=alg.NUMBER, name="Vic06", advanced=True,
           label="Vicarious gains for Oa06", default=1.0110, minValue=0)
@alg.input(type=alg.NUMBER, name="Vic07", advanced=True,
           label="Vicarious gains for Oa07", default=1.0079, minValue=0)
@alg.input(type=alg.NUMBER, name="Vic08", advanced=True,
           label="Vicarious gains for Oa08", default=1.0081, minValue=0)
@alg.input(type=alg.NUMBER, name="Vic09", advanced=True,
           label="Vicarious gains for Oa09", default=1.0057, minValue=0)
@alg.input(type=alg.NUMBER, name="Vic10", advanced=True,
           label="Vicarious gains for Oa10", default=1.0038, minValue=0)
@alg.input(type=alg.NUMBER, name="Vic11", advanced=True,
           label="Vicarious gains for Oa11", default=1.0040, minValue=0)
@alg.input(type=alg.NUMBER, name="Vic12", advanced=True,
           label="Vicarious gains for Oa12", default=0.9970, minValue=0)
@alg.input(type=alg.NUMBER, name="Vic13", advanced=True,
           label="Vicarious gains for Oa13", default=1.0000, minValue=0)
@alg.input(type=alg.NUMBER, name="Vic14", advanced=True,
           label="Vicarious gains for Oa14", default=1.0000, minValue=0)
@alg.input(type=alg.NUMBER, name="Vic15", advanced=True,
           label="Vicarious gains for Oa15", default=1.0000, minValue=0)
@alg.input(type=alg.NUMBER, name="Vic16", advanced=True,
           label="Vicarious gains for Oa16", default=0.9950, minValue=0)
@alg.input(type=alg.NUMBER, name="Vic17", advanced=True,
           label="Vicarious gains for Oa17", default=1.0000, minValue=0)
@alg.input(type=alg.NUMBER, name="Vic18", advanced=True,
           label="Vicarious gains for Oa18", default=1.0040, minValue=0)
@alg.input(type=alg.NUMBER, name="Vic19", advanced=True,
           label="Vicarious gains for Oa19", default=1.0000, minValue=0)
@alg.input(type=alg.NUMBER, name="Vic20", advanced=True,
...
def algorithm(instance, parameters, context, feedback, inputs):
    ...
    AverageTemperature = instance.parameterAsDouble(parameters, 'AverageTemperature', context)
