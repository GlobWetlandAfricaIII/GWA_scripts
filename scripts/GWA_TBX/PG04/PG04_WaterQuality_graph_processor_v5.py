...
@alg.input(type=alg.NUMBER, name="mem", default=1, minValue=1, maxValue=31,
...
def pg04waterqualityworkflowgraphprocessorv5(instance, parameters, context, feedback, inputs):
